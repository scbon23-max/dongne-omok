...
test("the betting UI keeps raise choices collapsed until requested", () => {
  ...
  assert.match(styles, /\.holdem-screen\.is-actioning #holdem-fold-btn \{ grid-column: 3; \}/);
  assert.match(styles, /\.holdem-screen\.is-actioning #holdem-check-btn,[\s\S]*#holdem-call-btn \{ grid-column: 2; \}/);
  assert.match(styles, /\.holdem-screen\.is-actioning #holdem-bet-btn,[\s\S]*#holdem-raise-btn,[\s\S]*#holdem-allin-btn \{ grid-column: 1; \}/);
