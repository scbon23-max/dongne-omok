...
test("the six-seat table exposes every required game control", () => {
  ...
  assert.match(styles, /\.holdem-screen\[data-card-front-skin="four-color"\] \.holdem-card\.is-hero-made-hand-card:not\(\.back\)\s*\{[\s\S]*inset 0 0 0 1px rgba\(255,220,105,\.72\)[\s\S]*0 0 6px rgba\(255,207,72,\.25\)/);
  assert.match(styles, /\.holdem-screen\[data-card-front-skin="four-color"\] \.holdem-card\.is-winning-combo-card:not\(\.back\)\s*\{[\s\S]*inset 0 0 0 1px rgba\(255,225,109,\.58\)[\s\S]*0 0 4px rgba\(255,207,72,\.18\)/);
...
test("hand results stay on the table without a popup and advance automatically", () => {
  ...
  assert.match(styles, /\.holdem-screen\[data-card-front-skin="four-color"\] \.holdem-card\.is-winning-combo-card:not\(\.back\)\s*\{[\s\S]*inset 0 0 0 1px rgba\(255,225,109,\.58\)/);
